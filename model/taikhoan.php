...
function register_taikhoan($username, $email, $password)
{
    ...
    $verification_link = "http://localhost/fpoly/du_an_1_nhom_8/index.php?act=verify&token=$token";
...
function send_password_reset_link($email)
{
    ...
    $reset_link = "http://localhost/fpoly/du_an_1_nhom_8/index.php?act=reset_password&token=$token";
