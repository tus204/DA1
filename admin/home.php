...
$count_comments = $CommentModel->count_comments();
...
<div class="container-fluid pt-4 px-4">
    <div class="row g-4">
        ...
        <div class="col-sm-6 col-xl-3">
            <a href="?quanli=binh-luan" class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                <i class="fas fa-comments fa-3x text-primary"></i>
                <div class="ms-3">
                    <p class="mb-2 text-dark">Bình luận</p>
                    <h6 class="mb-0"><?= $count_comments['total_comments'] ?> bình luận</h6>
                </div>
            </a>
        </div>
    </div>
