<div class="page-content">
    <header class="main-header fixed-top z-index bg-body position-relative d-none d-xl-block px-10 py-6">
        <div class="container-fluid">
            <nav class="navbar navbar-light py-0 row no-gutters px-3 px-lg-0">
                ...
                <div class="col-md-6 d-flex flex-wrap justify-content-md-end align-items-center order-0 order-md-1">
                    ...
                    <span class="request-full-screen d-block px-4 mx-3 fs-6" title="Full screen">
                    ...
                    <div class="dropdown pl-2 py-2">
                        ...
                        <div class="dropdown-menu dropdown-menu-end w-100">
                            <a class="dropdown-item" href="?act=dangxuat">Logout</a>
                        </div>
                    </div>
                </div>
            </nav>
