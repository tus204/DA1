            ...
            <div class="d-flex px-6 px-xl-10 w-100 border-bottom py-7 justify-content-between">
                <a href="../index-2.html" class="navbar-brand py-4">
                    ...
                    <img class="dark-mode-img" src="../assets/images/others/logo-white.png" width="179" height="26"
                        alt="Glowing - Bootstrap 5 HTML Templates"></a>
                ...
                <ul class="list-group list-group-flush list-group-no-border w-100 p-6">
                    ...
                    <li class="list-group-item px-0 py-0 sidebar-item mb-3 border-0">
                        <a href="index.php?act=taikhoan"
                            ...
                            <span class="sidebar-item-text fs-14px fw-semibold">Categories</span>
                        </a>
                    </li>
                            ...
                            <ul class="sub-menu list-unstyled">
                                <li class="sidebar-item">
                                    <a class="sidebar-link pe-5 ps-8 py-5 lh-1 text-decoration-none fs-14px fw-semibold"
                                        href="?act=sanpham" title="Product List">Product List</a>
                                </li>
                                <li class="sidebar-item">
                                    <a class="sidebar-link pe-5 ps-8 py-5 lh-1 text-decoration-none fs-14px fw-semibold"
                                        href="product-categories.html" title="Categoried">Add product</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="list-group-item px-0 py-0 sidebar-item mb-3 border-0">
                        <a href="starter-page.html"
                            ...
                            <span class="sidebar-item-text fs-14px fw-semibold">Voucher</span>
                        </a>
                    </li>
                </ul>
            </div>
