            ...
            <div class="card-body">
                <article class="card">
                    <div class="card-body row">
                        ...
                        <div class="col text-black"> <strong>Thời gian giao ước tính:</strong> <br><?= $delivery_date ?>
                        </div>
                ...
                <?php else: ?>
                    <div class="track">
                        ...
                        <div class="step <?php if ($status == 2 || $status == 3 || $status == 4)
                            echo 'active'; ?>">
                            <span class="icon">
                        ...
                        <div class="step <?php if ($status == 3 || $status == 4)
                            echo 'active'; ?>">
                            <span class="icon">
                                <i class="fa fa-truck text-black"></i>
                            </span>
                            <span class="text text-black">Trên đường giao</span>
                        </div>
                        <div class="step <?php if ($status == 4)
                            echo 'active'; ?>">
                            <span class="icon">
                                <i class="fa fa-check text-black"></i>
                            </span>
                            <span class="text text-black">Giao thành công</span>
                        </div>
                    </div>
                <?php endif; ?>
                        ...
                        <li class="col-md-4">
                            <figure class="itemside mb-3">
                                ...
                                <figcaption class="info align-self-center">
                                    ...
                                    <span class="text-primary"><?= number_format($price) ?>₫ </span> <span
                                        style="font-size: 16px;" class="text-dark">x<?= $quantity ?></span>
                                </figcaption>
                            </figure>
                        </li>
                        <?php
                    ...
                    <div class="col-lg-6">
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <hr>
                                <!-- Nút hủy đơn, chỉ hiện nếu status == 1 -->
                                <?php if ($status == 1): ?>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <form action="" method="POST">
                                                ...
                                                <button type="submit" class="btn btn-danger ml-5">Hủy đơn</button>
                                            </form>
                                        </div>
                                    </div>
                                <?php endif; ?>
