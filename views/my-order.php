                ...
                <div class="container-fluid mt-5">
                    <div class="row rounded justify-content-center mx-0 pt-5">
                        <div class="col-md-6 text-center">
                            <h4 class="mb-4">Chưa có đơn hàng nào</h4>
                            <a class="btn btn-primary rounded-pill py-3 px-4" href="index.php?url=cua-hang">Xem sản phẩm</a>
                            <a class="btn btn-secondary rounded-pill py-3 px-4" href="index.php">Trang chủ</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                                ...
                                <li class="col-md-4">
                                    <figure class="itemside mb-3">
                                        ...
                                        <figcaption class="info align-self-center">
                                            ...
                                            <span class="text-primary"><?= number_format($product_price) ?>₫</span> <span
                        ...
                        <div>
                            ...
                            <div class="float-right">
                                ...
                                <a href="index.php?url=chi-tiet-don-hang&id=<?= $order_id ?>" class="btn btn-custom"> Xem chi
                                    tiết</a>
                            </div>
                        </div>
                    </div>
