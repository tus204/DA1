...
$list_banner = $BannerModel->get_all_banners($order_by = 'title', $sort = 'ASC');

$listProducts = $ProductModel->select_products_limit(8);

$listCategories = $CategoryModel->select_categories_limit(6);

$product_limit_3 = $ProductModel->select_products_limit(3);
$product_order_by = $ProductModel->select_products_order_by(3, 'product_id');
$hot_sale = $ProductModel->select_products_order_by(3, 'price');
?>
    ...
    <div class="row">
            ...
            <div id="header-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner" style="border-radius: 10px;">
                    ...
                    foreach ($list_banner as $banner) {
                        extract($banner);
                        ?>
                        <div class="carousel-item <?= $isActive ? 'active' : '' ?>" style="max-height: 280px;">
                            <img class="img-fluid" src="./upload/<?= $image ?>" alt="Image">
                        </div>
                    <?php $isActive = false; } ?>
                </div>
        ...
        <div class="col-lg-4">
            <div class="product-offer">
                <img class="img-fluid" src="public/img/banner/banner-main-4.jpg" alt="">

            </div>
            <div class="product-offer">
                <img class="img-fluid" src="public/img/banner/banner-cake-5.jpg" alt="">
        ...
        <div class="row g-1 mb-4 mt-2 pb-4">
            <?php foreach ($listCategories as $value) {
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 text-center p-1 cate-gory">
                    <a href="<?= $link ?>"><img style="width: 150px; height: 100px; border-radius: 10%;"
                            src="upload/<?= $image ?>" alt=""></a>
                    <div class="mt-2">
                    ...
                    <div class="product__item sale">
                        <div class="product__item__pic set-bg" data-setbg="upload/<?= $image ?>">
                            ...
                            <ul class="product__hover">
                                <li><a href="upload/<?= $image ?>" class="image-popup"><span
                                            class="arrow_expand"></span></a>
                                </li>
                                <li>
                                    <a
                                        href="index.php?url=chitietsanpham&id_sp=<?= $product_id ?>&id_dm=<?= $category_id ?>">
...
<!-- Banner Section Begin -->
<!-- <section class="banner set-bg" data-setbg="public/img/banner/banner-6.jpg">
    <div class="container">
        <div class="row">
